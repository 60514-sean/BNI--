...
async function doLogin() {
  ...
  if (firstTab) {
    ...
    ['todoContent','mainContent','memberContent','dmContent','sloganContent','plateContent','signinContent','guestTrackContent','placardContent','nameplateContent','cardholderContent','scheduleContent','financeContent','meetingContent','sanchangContent','leadershipContent','reportContent'].forEach(id => {
