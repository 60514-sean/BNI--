...
async function doLogin() {
  ...
  if (firstTab) {
    ...
    ['todoContent','mainContent','memberContent','dmContent','sloganContent','signinContent','guestTrackContent','placardContent','scheduleContent','financeContent','meetingContent'].forEach(id => {
